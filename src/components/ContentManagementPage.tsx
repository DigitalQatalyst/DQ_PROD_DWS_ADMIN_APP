...
export const ContentManagementPage: React.FC = () => {
  ...
  // Note: We no longer block the page on error - just log it and show empty state
  // This allows all users to view the Content Management page
  if (error) {
    console.warn('Content fetch warning:', error);
  }
